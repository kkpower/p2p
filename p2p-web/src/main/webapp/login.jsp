...
<head>
    ...
    <style type="text/css">
        .testBtn-a{display: inline-block;height:30px;line-height:30px;padding:0 6px; border:0; border-radius:5px;color:#fff;background:rgb(65,133,244);cursor: pointer;}
